...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white text-black dark:bg-gray-900 dark:text-white p-4 shadow-lg border-b-2 border-gray-300 dark:border-gray-600">
      <div className="container mx-auto flex justify-between items-center">
        <NavLink to="/" className="text-3xl font-bold text-blue-500 dark:text-blue-400">
